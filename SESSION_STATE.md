...
## Current Phase
**Phase 7: Action RPG Completeness & Full Class Support — IN PROGRESS** — FEAT-005 complete, FEAT-006 complete (Ground Spell / AoE System), FEAT-007 complete (Class-Specific Skill Orchestration), FEAT-008 starting next
...
## In Progress
- **FEAT-007**: Class-Specific Skill Orchestration — Design data-driven rotation configs per class

## Next Actions
1. FEAT-007: Class-Specific Skill Orchestration — Create IRotationProvider interface and per-class rotation data
2. FEAT-008: Buff / Debuff Tracking System — Create BuffManager service
3. FEAT-009: Auto-Class Detection Enhancement — Improve DetectClass with more skill keys and heuristic scoring
