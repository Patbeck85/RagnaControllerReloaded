...
if (-not (Test-Path $unknownFile)) {
    # Generate a simple transparent 1x1 pixel or leave it to WPF to handle missing files
    Write-Host "Please ensure an 'unknown.png' fallback exists in the Assets/Classes folder." -ForegroundColor Yellow
}
